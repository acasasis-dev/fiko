  ...
  <aside class="main-sidebar" id="ms">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?= base_url()?>admin/users"><i class="fa fa-users"></i> <span>List of User</span></a></li> 

        <li class="active"><a href="<?= base_url()?>admin/question"><i class="fa fa-question"></i> <span>Question</span></a></li> 
