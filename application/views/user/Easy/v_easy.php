  ...
  <div class="content-wrapper">
    ...
    <div class="container">
      ...
      <section class="content">
        <div class="col-md-3">
          <a href="<?= base_url() ?>/user/test/test/ha" class="btn btn-success" id="testbutton">Skill 1</a><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VOWELS
        </div>
        <div class="col-md-3">
          <a href="<?= base_url() ?>user/test/test/med" class="btn btn-success" id="testbutton">Skill 2</a><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CONSONANTS
        </div>
        <div class="col-md-3">
          <a href="<?= base_url() ?>user/test/test/haha" class="btn btn-success" id="testbutton">Skill 3</a><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MIXED VOWELS & CONSONANTS
        </div>
         <div class="col-md-3">
          <a href="<?= base_url() ?>user/test/test/hahaha" class="btn btn-success" id="testbutton">Skill 4</a><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NUMBERS
        </div>
