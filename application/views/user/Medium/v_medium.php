  ...
  <div class="content-wrapper">
    ...
    <div class="container">
      ...
      <section class="content">
        <div class="col-md-3">
          <a href="<?= base_url() ?>/user/test/test/hamon" class="btn btn-success" id="testbutton">Skill 1</a><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ANIMALS
        </div>
        <div class="col-md-3">
          <a href="<?= base_url() ?>user/test/test/hamonado" class="btn btn-success" id="testbutton">Skill 2</a><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VEHICLES
        </div>
        <div class="col-md-3">
          <a href="<?= base_url() ?>user/test/test/hamburger" class="btn btn-success" id="testbutton">Skill 3</a><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OCASSION
        </div>
         <div class="col-md-3">
          <a href="<?= base_url() ?>user/test/test/hamsilog" class="btn btn-success" id="testbutton">Skill 4</a><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;GREETINGS
        </div>
